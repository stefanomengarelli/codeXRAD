 ...
 *
 *  codeXRAD static basic class: strings.
 *  
 *  ------------------------------------------------------------------------
 */
...
namespace codeXRAD
{
    ...
    /// <summary>codeXRAD static basic class: strings.</summary>
    static public partial class CX 
    {
        ...
        /// <summary>Initialize static string class environment.</summary>
        static public void InitializeStrings()
        {
            CR = "\r\n";
            DecimalSeparator = ',';
        ...
        public static char ThousandSeparator { get; set; }
        ...
        static public string After(string _String, string _SubString)
        {
        ...
        static public int AscU(char _Char)
        {
            return (int)_Char;
        }

        /// <summary>Returns Unicode code of string first char.</summary>
        static public int AscU(string _String)
        {
        ...
        static public string Base64Decode(string _String)
        {
        ...
        static public string Before(string _String, string _Substring)
        {
            int i = _String.IndexOf(_Substring);
        ...
        static public bool Bool(char _Char)
        {
        ...
        static public string Btw(string _String, string _BeginSubstring, string _EndSubstring)
        {
        ...
        /// If one of two substrings are not present returns empty string.</summary>
        static public string BtwU(string _String, string _BeginSubstring, string _EndSubstring)
        {
        ...
        static public string Cat(string _String, string _NewString, string _Separator)
        {
        ...
        static public string Cat(string[] _StringArray, string _Separator, bool _ExcludeEmptyStrings)
        {
            int i, h;
        ...
        static public int CheckSum(string _String)
        {
            int i = 0, j = 0, k, r = 0;
            int[] p = { 1, 7, 2, 3, 5 };
        ...
        static public char Chr(int _AsciiCode)
        {
            return (char)(_AsciiCode % 256);
        }

        /// <summary>Returns how many char founded in string.</summary>
        static public int ChrCount(string _String, char _Char)
        {
        ...
        static public char ChrLoop(string _String, int _Index)
        {
            if (_String.Length > 0)
            {
        ...
        static public bool ChrRepeated(string _String)
        {
            bool r = false;
            int i = 0, j;
        ...
        static public string ChrReplace(string _String, char _OldChar, char _NewChar)
        {
        ...
        static public string ChrReplace(string _String, string _Chars, char _NewChar)
        {
            int i = 0;
            StringBuilder r = new StringBuilder();
            while (i < _String.Length)
        ...
        static public int ChrToInt(char _Char)
        {
            if (_Char == '9') return 9;
        ...
        static public int Compare(string _StringA, string _StringB)
        {
            int r = 0, i = 0;
        ...
        static public int Compare(string _StringA, string _StringB, bool _IgnoreCase, bool _PartialMode)
        {
            if (_PartialMode)
            {
        ...
        static public bool Empty(string _String)
        {
        ...
        static public bool Empty(string[] _StringArray)
        {
        ...
        static public string Escape(string _String)
        {
            int i;
            StringBuilder s;
            if (_String != null)
        ...
        static public string Extract(ref string _String, char _Separator)
        {
            string r;
        ...
        /// The function store in to string the part remaining (without extracted part and separator).</summary>
        static public string Extract(ref string _String, string _Separators)
        {
            string r;
        ...
        static public string ExtractDigits(ref string _String, int _DigitsCount)
        {
            bool b = true;
            string r = "";
        ...
        static public string ExtractLine(ref string _String)
        {
            int i;
            string r;
            //
        ...
        static public string ExtractLine(ref string _String, string _LineSeparator)
        {
            string r;
        ...
        /// <summary>Extract a parameter from command line string.</summary>
        static public string ExtractParam(ref string _String)
        {
            string q = _String.Trim();
            int i = 0, a = 0, b = 0;
            while ((i < q.Length) && (b < 1))
            {
                if (i == 0)
                {
                    if (q[i] == '"') a = 1;
            ...
            {
                _String = "";
                return q.Substring(a);
            }
            else
            {
                _String = q.Substring(b + 1);
                return q.Substring(a, b - a);
            }
        }
        ...
        public static string ExtractVersion(string _EntireVersion, int _VersionLevel, int _Zeroes)
        {
            string r = "";
            while (_VersionLevel > 0)
            {
        ...
        static public string Flat(string _String)
        {
            return _String.Replace("\r\n", " ").Replace("\n", " ").Replace("\r", " ").Replace("\t", " ");
        }

        /// <summary>Returns string representing values in binary array.</summary>
        static public string FromBinArray(bool[] _Array)
        {
            int i;
            string r = "";
        ...
        static public string FromHexDump(string _HexDump, string _Password)
        {
        ...
        static public string FromHexMask(string _HexMask, string _Password)
        {
            string r, s;
        ...
        static public string GetDigits(string _String, bool _Decimals)
        {
            char c;
            int i = 0, l;
            string r = "";
        ...
        static public string GetValidChars(string _String, string _ValidChars)
        {
            int i = 0;
            StringBuilder r = new StringBuilder();
            while (i < _String.Length)
        ...
        static public string Iif(bool _BoolTest, string _ReturnIfTrue, string _ReturnIfFalse)
        {
        ...
        static public string Indent(string _String, string _Indent, int _Shift)
        {
            int i;
            string l, q = "";
            StringBuilder r;
        ...
        static public string InsBtw(string _String, string _NewString, string _Substring1, string _Substring2)
        {
            string a, b;
        ...
        static public string InsBtwU(string _String, string _NewString, string _Substring1, string _Substring2)
        {
            string a, b;
        ...
        static public string IntToHex(Int64 _Value, int _Digits)
        {
        ...
        static public string Invert(string _String)
        {
            StringBuilder r = new StringBuilder();
        ...
        static public bool IsAlpha(string _String)
        {
            int l = _String.Length;
            bool r = (l > 0);
            while (r && (l > 0))
        ...
        static public bool IsAlphaNum(string _String)
        {
            int l = _String.Length;
            bool r = (l > 0);
            while (r && (l > 0))
        ...
        static public bool IsCharSet(string _String, string _CharSet)
        {
            int l = _String.Length;
            bool r = true;
            while (r && l > 0)
        ...
        static public bool IsDigits(string _String)
        {
            int l = _String.Length;
            bool r = (l > 0);
            while (r && (l > 0))
        ...
        static public bool IsHex(string _String)
        {
            int l = _String.Length;
            bool r = (l > 0);
            while (r && (l > 0))
        ...
        static public bool IsHexMask(string _String)
        {
            bool r = false;
            if (_String.Length > 4)
            {
        ...
        static public string Left(string _String, int _Length)
        {
        ...
        static public string PadL(string _String, int _Length, char _FillChar)
        {
        ...
        static public string PadR(string _String, int _Length, char _FillChar)
        {
        ...
        static public int Pos(string _Substring, string _String)
        {
        ...
        /// The function returns -1 if char is not found.</summary>
        static public int Pos(string _Chars, string _String, bool _IgnoreCase)
        {
            int i = 0, j, r = -1;
        ...
        /// The function returns -1 if char is not found.</summary>
        static public int PosR(char _Char, string _String)
        {
        ...
        static public int PosR(string _String, string _Substring)
        {
        ...
        /// The function returns -1 if char is not found.</summary>
        static public int PosR(string _Chars, string _String, bool _IgnoreCase)
        {
            int i = 0, j, r = -1;
            if ((_Chars.Length > 0) && (_String.Length > 0))
            {
        ...
        static public string Remove(string _String, char _CharToRemove)
        {
            int i = 0;
            StringBuilder r = new StringBuilder();
            while (i < _String.Length)
        ...
        static public string Replace(string _String, string _OldString, string _NewString)
        {
        ...
        static public string Replicate(string _String, int _Count)
        {
            StringBuilder r = new StringBuilder();
            while (_Count > 0)
            {
        ...
        static public string Right(string _String, int _Length)
        {
            if (_Length < 1) return "";
        ...
        static public string RndName(int _Length)
        {
            StringBuilder r = new StringBuilder();
        ...
        static public string Space(int _Length)
        {
            StringBuilder s;
            if (_Length > 0)
            {
        ...
        static public List<string> Split(string _String, string _Separators, bool _TrimSpaces)
        {
        ...
        /// considering separator chars.</summary>
        static public void Split(List<string> _StringList, string _String, string _Separators, bool _TrimSpaces)
        {
            if (_StringList != null)
            {
                if (_TrimSpaces)
        ...
        static public List<string> SplitLines(string _String, bool _TrimSpaces)
        {
            List<string> r = new List<string>();
            if (_TrimSpaces)
            {
        ...
        /// <summary>Return collection of strings splitted from original string 
        /// considering carriage return.</summary>
        static public void SplitLines(List<string> _StringList, string _String, bool _TrimSpaces)
        {
            if (_StringList != null)
            {
                if (_TrimSpaces)
        ...
        static public string Str(byte[] _BytesArray)
        {
        ...
        static public string Str(byte[] _BytesArray, Encoding _Encoding)
        {
            bool bom;
            if (_BytesArray != null)
            {
        ...
        static public string Str(string[] _Strings)
        {
            int i;
            StringBuilder r = new StringBuilder();
            if (_Strings != null)
        ...
        static public string Str(List<string> _Strings, bool _TrimStrings)
        {
            int i;
            StringBuilder r = new StringBuilder();
            if (_Strings != null)
        ...
        static public List<string> StrList(string _String)
        {
            List<string> r = new List<string>();
        ...
        static public void StrList(string _String, List<string> _StringList, bool _TrimStrings)
        {
            if (_StringList != null)
            {
                _StringList.Clear();
        ...
        static public void StrList(string _String, List<string> _StringList, string _Separators, bool _TrimStrings, bool _IgnoreEmpty)
        {
            string s;
            if (_StringList != null)
            {
        ...
        static public string ToHexDump(string _String, string _Password)
        {
        ...
        static public string ToHexMask(string _String, string _Password)
        {
            if (_String.Length > 0)
            {
        ...
        static public int ToInt(string _String)
        {
            try
            {
        ...
        static public long ToLong(string _String)
        {
            try
            {
        ...
        static public string TrimR(string _String)
        {
            return _String.TrimEnd();
        }

        /// <summary>Returns string value removing all ending (from right) recurrences.</summary>
        static public string TrimR(string _String, string _Recurrence)
        {
            int l = _Recurrence.Length;
        ...
        static public string Trunc(string _String, int _MaxLength)
        {
        ...
        static public string Unescape(string _String)
        {
            int i = 0;
            bool e = false;
        ...
        static public string Unquote(string _String)
        {
            if (_String.Length > 1)
            {
                if ((_String[0] == '\'') && (_String[_String.Length - 1] == '\''))
        ...
        static public string Unquote2(string _String)
        {
            if (_String.Length > 1)
            {
                if ((_String[0] == '"') && (_String[_String.Length - 1] == '"'))
        ...
        static public double Val(string _String)
        {
            try
            {
                return Convert.ToDouble(GetDigits(_String, true));
        ...
        static public string WBtw(string _String, string _NewString, string _BeginSubstring, string _EndSubstring)
        {
            string a, b;
            int i = _String.IndexOf(_BeginSubstring);
            if (i > -1)
        ...
        static public string WildCardToRegEx(string _WildCard)
        {
        ...
        static public bool WildCardMatch(string _String, string _WildCard, bool _CaseSensitive)
        {
            Regex r;
        ...
        static public string Wrap(string _Text, int _CharWidth, bool _FlatString)
        {
            int i = 0;
            string l, p;
            StringBuilder r = new StringBuilder();
        ...
        static public string Zeroes(double _Value, int _Length)
        {
        ...
        /// <summary>Returns a string with length characters, representing integer value leaded by zeroes.</summary>
        static public string Zeroes(int _Value, int _Length)
        {
