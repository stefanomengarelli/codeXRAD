 ...
 *
 *  codeXRAD static basic class: math.
 *
 *  ------------------------------------------------------------------------
 */
...
namespace codeXRAD
{
    ...
    /// <summary>codeXRAD static basic class: math.</summary>
    static public partial class CX
    {
        ...
        /// <summary>Initialize static settings class environment.</summary>
        static public void InitializeMath()
        {
            CurrencyFormat = @"###,###,###,###,##0.00";
        ...
        public static string CurrencyPrecisionFormat { get; set; }
        ...
        static public int Abs(int _Value)
        {
        ...
        static public long Abs(long _Value)
        {
            if (_Value < 0) return -_Value;
            else return _Value;
        }
        ...
        static public double Abs(double _Value)
        {
        ...
        static public long BaseToInt(string _Value, string _BaseChars)
        {
        ...
        static public int BinToInt(string _String)
        {
        ...
        static public int BinToInt(bool[] _Array)
        {
            int r = 0, i = 0, b = 1;
            if (_Array != null)
            {
        ...
        static public bool DivMod(int _Dividend, int _Divisor, ref int _Result, ref int _Remainder)
        {
            try
            {
        ...
        static public double Frac(double _Value)
        {
            return _Value - Math.Truncate(_Value);
        }

        /// <summary>Returns one of integer specified for test if true or false.</summary>
        static public int Iif(bool _Test, int _ReturnIfTrue, int _ReturnIfFalse)
        {
        ...
        static public decimal Iif(bool _Test, decimal _ReturnIfTrue, decimal _ReturnIfFalse)
        {
            if (_Test) return _ReturnIfTrue;
            else return _ReturnIfFalse;
        }
        ...
        static public double Iif(bool _Test, double _ReturnIfTrue, double _ReturnIfFalse)
        {
            if (_Test) return _ReturnIfTrue;
            else return _ReturnIfFalse;
        }
        ...
        static public double InchToMm(double _Inches)
        {
            return _Inches * 25.4d;
        }

        /// <summary>Returns integer part of double precision value.</summary>
        static public double Int(double _Value)
        {
        ...
        static public string IntToBase(long _Value, string _BaseChars)
        {
        ...
        static public void IntToBinArray(int _Value, bool[] _Array)
        {
            int i, j;
            bool[] q = new bool[16];
            if (_Array != null)
        ...
        static public byte Max(byte _A, byte _B)
        {
            if (_A > _B) return _A;
            else return _B;
        }
        ...
        /// <summary>Return greater value between a and b.</summary>
        static public long Max(long _A, long _B)
        {
            if (_A > _B) return _A;
            else return _B;
        }
        ...
        /// <summary>Return greater value between a and b.</summary>
        static public double Max(double _A, double _B)
        {
            if (_A > _B) return _A;
            else return _B;
        }
        ...
        /// <summary>Return greater value between a and b.</summary>
        static public decimal Max(decimal _A, decimal _B)
        {
            if (_A > _B) return _A;
            else return _B;
        }
        ...
        static public byte Min(byte _A, byte _B)
        {
            if (_A < _B) return _A;
            else return _B;
        }
        ...
        /// <summary>Return lesser value between a and b.</summary>
        static public long Min(long _A, long _B)
        {
            if (_A < _B) return _A;
            else return _B;
        }
        ...
        /// <summary>Return lesser value between a and b.</summary>
        static public double Min(double _A, double _B)
        {
            if (_A < _B) return _A;
            else return _B;
        }
        ...
        /// <summary>Return lesser value between a and b.</summary>
        static public decimal Min(decimal _A, decimal _B)
        {
            if (_A < _B) return _A;
            else return _B;
        }
        ...
        /// <summary>Returns percent value related to max.</summary>
        static public double Percent(double _Value, double _Max, bool _MaxTo100)
        {
            double r;
            if (_Max == 0.0d) r = 0.0d;
        ...
        static public int Percent(int _Value, int _Max, int _RangeStart, int _RangeEnd)
        {
        ...
        static public double Percent(int _Value, int _Max, int _DecimalsCount)
        {
            double r;
            if (_Max == 0) r = 0.0d;
        ...
        /// <summary>Returns percent double value related to max with decimals.</summary>
        static public double Percent(double _Value, double _Max, int _DecimalsCount)
        {
            double r;
            if (_Max == 0.0d) r = 0.0d;
        ...
        static public int Rotor(int _Max, string _Key)
        {
            int i, k, r = 0;
            if ((_Max > 0) && (_Key != null))
            {
        ...
        static public double RoundDouble(double _Value, int _DecimalsCount)
        {
            double d, f = 1.0d, i;
        ...
        static public int Scale(int _Value, int _SourceRangeStart, int _SourceRangeEnd, 
        ...
        static public double Scale(double _Value, double _SourceRangeStart, double _SourceRangeEnd, 
        ...
        static public int Sign(int _Value)
        {
        ...
        /// <summary>Returns integer -1 if value is negative, 1 if positive, 0 if zero.</summary>
        static public int Sign(double _Value)
        {
        ...
        static public int Threshold(int _Value, int _Threshold, int _Increment)
        {
            int r;
        ...
        static public int Trunc(double _Value)
        {
