 ...
 *
 *  codeXRAD IBAN code static class.
 *
 *  ------------------------------------------------------------------------
 */
...
namespace codeXRAD
{
    ...
    /// <summary>Microrun XRad IBAN code static class.</summary>
    static public class CXIban
    {
        ...
        public static string CIN(string _ABI_Code, string _CAB_Code, string _CC_Account_Number)
        {
            ...
            if (CX.IsDigits(_ABI_Code) && CX.IsDigits(_CAB_Code) && CX.IsAlphaNum(_CC_Account_Number))
            {
                _ABI_Code = CX.Right(@"00000" + _ABI_Code, 5);
                _CAB_Code = CX.Right(@"00000" + _CAB_Code, 5);
                _CC_Account_Number = CX.Right(@"000000000000" + _CC_Account_Number, 12);
        ...
        public static bool Validate(string _CIN_Code, string _ABI_Code, string _CAB_Code, string _CC_Account_Number, bool _ValidateIfEmpty)
        {
